  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4">
      <Container size="sm" className="w-full max-w-lg">
        <Paper withBorder p="xl" radius="lg" className="bg-white shadow-md border-slate-200">
          <div className="flex flex-col items-center mb-6 text-center">
            <div className="w-14 h-14 bg-blue-50 text-[#0F4C81] rounded-2xl flex items-center justify-center mb-3 border border-blue-100 shadow-xs">
              <Lock size={28} />
            </div>
            <Title order={3} className="text-[#0F4C81] font-bold">Set New Password</Title>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Paper withBorder p="sm" radius="md" className="bg-slate-50 border-slate-200">
              <div className="flex items-center gap-1.5 text-[#0F4C81] font-bold text-xs mb-2">
                <ShieldCheck size={16} />
            ...
            <div className="text-center pt-1">
               <a href="/" className="text-xs font-semibold text-[#0F4C81] hover:underline">
                 ← Back to Sign In
               </a>
            </div>
          </form>
